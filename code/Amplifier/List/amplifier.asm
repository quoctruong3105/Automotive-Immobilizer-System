...
_0xA:
	.DB  0xE,0x0,0xD,0x0,0xB,0x0,0x7
_0xB:
	.DB  0x37,0x0,0x38,0x0,0x39,0x0,0x2F,0x0
	.DB  0x34,0x0,0x35,0x0,0x36,0x0,0x2A,0x0
	.DB  0x31,0x0,0x32,0x0,0x33,0x0,0x2D,0x0
	.DB  0x4E,0x0,0x30,0x0,0x3D,0x0,0x2B
...
; 0000 0023                 if(keyin == scan_code[j])
	MOVW R30,R18
	LDI  R26,LOW(_scan_code)
	LDI  R27,HIGH(_scan_code)
	RCALL SUBOPT_0x0
	CP   R30,R20
	CPC  R31,R21
	BRNE _0x13
...
; 0000 0025                     return ascii_code[j][i];
	MOVW R30,R18
	CALL __LSLW3
	SUBI R30,LOW(-_ascii_code)
	SBCI R31,HIGH(-_ascii_code)
	MOVW R26,R30
	MOVW R30,R16
	RCALL SUBOPT_0x0
	RJMP _0x2000001
